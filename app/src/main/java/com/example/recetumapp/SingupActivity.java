                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(SingupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(SingupActivity.this, "crear usuario con email:completado:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                ...
                                if (!task.isSuccessful()) {
                                    Toast.makeText(SingupActivity.this, "Autentificacion fallida." + task.getException(),
